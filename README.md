...
Lightweight webhook dispatcher with retry logic in C.

## 🚀 Overview
This repository contains a professional implementation of **C Webhook Dispatcher**. It is designed with clean code principles and focuses on functionality and reliability.
